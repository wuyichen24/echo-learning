...
- Keep the same stucture between the Postman collection and this repository (It makes easy to find the corresponding Postman request to test the example you want).
